...
def main():
    ...
    ap.add_argument('--img-root', help='Image root to prune ignored images from. Optional. If given, it will prune images. Else, it will not.', type=str)
    args = ap.parse_args()

    ignore_prune_from_file(args.json, ignore_list=args.ignore, out_json=args.out, img_root=args.img_root)
