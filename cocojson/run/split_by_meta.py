...
def main():
    ...
    ap.add_argument('--preserve-img-id', help='Flag to preserve image ids', action='store_true')
    args = ap.parse_args()

    split_by_meta_from_file(args.cocojson, args.attribute, preserve_img_id=args.preserve_img_id)
